<?php
    if (isset($_POST['izracunaj'])){
        ...
        if ($_POST['izborni3'] == "Objektno programiranje (C++)")
            $k[2] = $kR;
        else
            $k[2] = 1;
            
        if ($_POST['izborni4'] == "Objektno programiranje (C++)")
            $k[3] = $kR;
        else
            $k[3] = 1;
...
<html>
    ...
    <body> <div class="kontejner">
			<div class="navigacija">
				<ul>
					<li> <a href="index.php"> Zimski Semestar </a></li>
        ...
        <form method="post">
            ...
            <fieldset class="crveni" id="fieldset2">
                ...
                <label for="">Engleski jezik struke 1</label> <input type="number" name="str2[]" min="2" max="5" <?php if (isset($_POST['izracunaj'])) echo "value='{$s2[0]}'" ?>/><br>
                ...
                <label for="">Algebarske strukture</label> <input type="number" name="mat6[]" min="2" max="5" <?php if (isset($_POST['izracunaj'])) echo "value='{$m6[3]}'" ?>/><br>
            ...
            <fieldset class="plavi" id="fieldset3">
                ...
                <label for="">Obične diferencijalne jednadžbe</label> <input type="number" name="mat6[]" min="2" max="5" <?php if (isset($_POST['izracunaj'])) echo "value='{$m6[4]}'" ?>/><br>
                ...
                <label for="">Teorija skupova</label> <input type="number" name="mat6[]" min="2" max="5" <?php if (isset($_POST['izracunaj'])) echo "value='{$m6[5]}'" ?>/><br>
                <label for="">Mreže računala</label> <input type="number" name="rac5[]" min="2" max="5" <?php if (isset($_POST['izracunaj'])) echo "value='{$r5[0]}'" ?>/><br>
                                
                <hr/>
                
                <label for="">Kompleksna analiza</label> <input type="number" name="mat6[]" min="2" max="5" <?php if (isset($_POST['izracunaj'])) echo "value='{$m6[6]}'" ?>/><br>
                <label for="">Statistika</label> <input type="number" name="mat7[]" min="2" max="5" <?php if (isset($_POST['izracunaj'])) echo "value='{$m7[3]}'" ?>/><br>
                <label for="">Metode Mmatematičke fizike</label> <input type="number" name="mat7[]" min="2" max="5" <?php if (isset($_POST['izracunaj'])) echo "value='{$m7[4]}'" ?>/><br>
                <label for="">Mjera i integral</label> <input type="number" name="mat6[]" min="2" max="5" <?php if (isset($_POST['izracunaj'])) echo "value='{$m6[7]}'" ?>/><br>
                ...
                <select class="selekt" name="izborni3">
                    ...
                    <option <?php if (isset($_POST['izracunaj']) && $_POST['izborni3']=="Teorija brojeva") echo "selected='selected'" ?> >Teorija brojeva</option>
            ...
            <input id="fieldset6" class="button" type="submit" name="izracunaj" value="Izračunaj" />
        </form>    
		</div>
    </div>
	</body>
